const CACHE='little-moments-v248';
const ASSETS=['./','./index.html','./styles.css','./home-fit.css','./cover-fit.css','./moments-view.css','./display-print.css','./display-photo-fill-fix.css','./portfolio-view.css','./portfolio-print.css','./portfolio-print-fix.css','./print-system.css','./make-it-yours-refine.css','./soft-botanical.css','./student-profile.css','./teacher-tools.css','./class-manager.css','./class-setup.css','./settings-view.css','./data-safety.css','./portfolio-theme-settings.css','./capture-choice.css','./capture-date.css','./app.js','./moments-view.js','./settings-navigation.js','./display-print.js','./portfolio-lazy-loader.js','./student-profile.js','./teacher-tools.js','./class-manager.js','./class-setup.js','./class-setup-navigation.js','./version-badge.js','./db.js','./atomic-restore.js','./auto-recovery.js','./data-safety.js','./storage-diagnostic.js','./recovery-inspector.js','./school-name-settings.js','./portfolio-theme-settings.js','./google-drive-test.js','./google-drive-backup.js','./drive-reliability.js','./emergency-mirror.js','./capture-choice.js','./capture-favorite.js','./profile-photo.js','./recent-photo-fix.js','./recent-preference.js','./preference-behavior.js','./year-rollover.js','./year-history.js','./route-cleanup.js','./manifest.webmanifest','./plain_polaroid.png','./early_eagle_polaroid.png','./Woodland_plaroid.png','./Colorfol_Classroom_polaroid.png','./make_it_yours_polaroid_base.png','./Soft_Botanical_Individual_Polaroid_Master.png','./Soft_Botanical_Portfolio_Cover_8.5x11_300dpi.png','./Soft_Botanical_Page_A_8.5x11_300dpi.png','./Soft_Botanical_Page_B_8.5x11_300dpi.png','./Soft_Botanical_Page_C_8.5x11_300dpi.png','./Soft_Botanical_Page_D_8.5x11_300dpi.png','./little_moments_icon.png','./lm%20background.png','./lm%20camera.png','./lm%20moments.png','./lm%20scrapbook.png','./assets/home-moments.svg','./assets/home-portfolio.svg','./assets/home-botanical.svg','./assets/home-empty-moments.svg'];
